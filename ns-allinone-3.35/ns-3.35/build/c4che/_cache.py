...
CFLAGS_PYEMBED = ['-fno-strict-overflow', '-g', '-O2']
CFLAGS_PYEXT = ['-fno-strict-overflow', '-g', '-O2']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-overflow', '-g', '-O2']
CXXFLAGS_PYEXT = ['-fno-strict-overflow', '-g', '-O2', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['stats', 'socket', 'realtime', 'udp', 'channel-models', 'traffic-control', 'tcp', 'energy', 'udp-client-server', 'ipv6', 'tutorial', 'naming', 'error-model', 'matrix-topology', 'routing', 'wireless']
...
LIBPATH_PYEMBED = ['/usr/lib/python3.12/config-3.12-x86_64-linux-gnu', '/usr/lib/x86_64-linux-gnu']
LIBPATH_PYEXT = ['/usr/lib/python3.12/config-3.12-x86_64-linux-gnu', '/usr/lib/x86_64-linux-gnu']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['python3.12', 'dl', 'm', 'python3.12', 'dl', 'm']
LIB_PYEXT = ['dl', 'm', 'dl', 'm']
LIB_RT = ['rt']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/home/gabriel_pc/cloud-storage-ns3/ns-allinone-3.35/ns-3.35/build/src/fd-net-device', '/home/gabriel_pc/cloud-storage-ns3/ns-allinone-3.35/ns-3.35/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/13', '/home/gabriel_pc/cloud-storage-ns3/ns-allinone-3.35/ns-3.35/build/lib', '/home/gabriel_pc/cloud-storage-ns3/ns-allinone-3.35/ns-3.35/build']
...
VERSION = '3.35'
WITH_PYBINDGEN = '/home/gabriel_pc/cloud-storage-ns3/ns-allinone-3.35/pybindgen-0.22.0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/gabriel_pc/cloud-storage-ns3/ns-allinone-3.35/ns-3.35/build/ns3/config-store-config.h', '/home/gabriel_pc/cloud-storage-ns3/ns-allinone-3.35/ns-3.35/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
